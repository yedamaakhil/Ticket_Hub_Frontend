      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-xl p-5">
            ...
            <p className="text-gray-400 text-sm">support@tickethub.com</p>
          </div>
        </div>
        ...
        <div className="bg-primary/5 border border-primary/20 rounded-xl p-5">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <input
              ...
              required
              className="w-full px-4 py-2 bg-primary/10 border border-primary/20 rounded-lg focus:outline-none focus:border-primary text-white text-sm"
            />
            ...
            <textarea
              ...
              required
              rows="4"
              className="w-full px-4 py-2 bg-primary/10 border border-primary/20 rounded-lg focus:outline-none focus:border-primary text-white text-sm resize-none"
            />
            
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-primary hover:bg-primary-dull rounded-lg text-sm font-medium transition-all active:scale-95"
            >
              Send Message
