...
function Footer() {
  return (
    <footer className="bg-gradient-to-b from-black via-black to-red-950/80 w-full text-white pt-8 lg:pt-12 px-4 sm:px-8 md:px-16 lg:px-28 overflow-hidden mt-12 lg:mt-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-6 gap-8 md:gap-12">
        ...
        <div className="lg:col-span-3 space-y-5 sm:space-y-6">
          <a href="https://prebuiltui.com" className="block">
            <img className='h-12 sm:h-16 md:h-20 lg:h-25 w-40 sm:w-48 md:w-64 lg:w-80 max-w-full object-contain' src={assets.a} alt="TicketHub" />
          </a>
          ...
          <div className="flex gap-4 sm:gap-5 md:gap-6 flex-wrap">
          ...
          <div className="flex items-center gap-2 mt-4 flex-wrap">
            <img src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/refs/heads/main/assets/appDownload/googlePlayBtnBlack.svg" alt="google play" className="h-9 sm:h-10 w-auto border border-white rounded" />
            <img src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/refs/heads/main/assets/appDownload/appleStoreBtnBlack.svg" alt="app store" className="h-9 sm:h-10 w-auto border border-white rounded" />
          </div>
        </div>

        {/* Links Sections */}
        <div className="lg:col-span-3 grid grid-cols-2 sm:grid-cols-3 gap-6 sm:gap-8 md:gap-12 lg:gap-28 items-start">
          <div>
            <h3 className="font-medium text-sm mb-3 sm:mb-4 text-white">Company</h3>
            <ul className="space-y-2.5 sm:space-y-3 text-sm text-neutral-300">
          ...
          <div>
            <h3 className="font-medium text-sm mb-3 sm:mb-4 text-white">Resources</h3>
            <ul className="space-y-2.5 sm:space-y-3 text-sm text-neutral-300">
          ...
          <div className="col-span-2 sm:col-span-1">
            <h3 className="font-medium text-sm mb-3 sm:mb-4 text-white">Get in Touch</h3>
            <ul className="space-y-2.5 sm:space-y-3 text-sm text-neutral-300">
              <li><a href="#" className="hover:text-red-400 transition-colors">+91 1234567890</a></li>
              <li><a href="#" className="hover:text-red-400 transition-colors break-all">tickethub.online@gmail.com</a></li>
              <li>
      ...
      {/* Bottom Bar */}
      <div className="max-w-7xl mx-auto mt-10 sm:mt-12 pt-4 border-t border-red-900/50 flex flex-col sm:flex-row gap-2 justify-between items-center text-center sm:text-left">
        <p className="text-neutral-400 text-xs sm:text-sm">© 2026 <b>Ticket Hub</b> All right reserved.</p>
      </div>
      ...
      <div className="relative">
        ...
        <h3 className="text-center font-extrabold leading-[0.7] text-transparent text-[clamp(2.2rem,15vw,15rem)] [-webkit-text-stroke:1px_#450a0a] mt-6 px-2" >
          TicketHub
        </h3>
      </div>
    </footer>
